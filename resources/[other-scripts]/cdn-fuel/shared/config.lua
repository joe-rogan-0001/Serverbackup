...
Config.JerryCanCap = 30 -- Maximum amount (in L) the jerrycan can fit! (Default: 50L)
Config.JerryCanPrice = 250 -- The price of a jerry can, not including tax.
Config.JerryCanGas = 30 -- The amount of Gas that the Jerry Can you purchase comes with. This should not be bigger that your Config.JerryCanCap!
...
Config.AirAndWaterVehicleFueling = {
    ...
    ['locations'] = {
        ...
        [10] = {
            ['PolyZone'] = {
                ['coords'] = {
                    vector2(1846.02, 3708.04),
                    vector2(1855.25, 3713.43),
                    vector2(1860.72, 3704.47),
                    vector2(1851.58, 3699.04)
                },
                ['minmax'] = {
                    ['min'] = 29.00,
                    ['max'] = 37.50
            ...
            ['prop'] = {
                ['model'] = 'prop_gas_pump_1d',
                ['coords'] = vector4(1855.19, 3715.06, 32.97, 211),
            }
        },
        -- Grapeseed Airfield
        [11] = {
...
Config.GasStations = { -- Configuration options for various gas station related things, including peds, coords and labels.
    ...
    [28] = {
        zones = {
            vector2(186.90, -893.01),
            vector2(193.64, -875.49),
            vector2(251.23, -896.34),
            vector2(245.24, -912.65)
        },
        minz = 25.5,
        maxz = 35.9,
        pedmodel = "a_m_m_indian_01",
        ...
        electriccharger = nil,
        electricchargercoords = vector4(209.56, -898.47, 28.66, 162),
        label = "Legion Square Gas Station",
    },
    --[[
