...
Config.Framework = 'qb' -- You can choose between 'esx' or 'qb'.
Config.Language = 'en' -- Available languages by default: 'es' or 'en', you can create more if you wish.

Config.InventoryScript = 'qb' -- 'qs', 'qb', 'core_inventory', 'ox'
Config.MenuType = 'qb' -- 'ox_lib', 'esx_context', 'esx_menu_default', 'nh', 'qb'
Config.TextUI = 'qb' -- 'ox_lib', 'esx_textui', 'qb', 'okokTextUI', 'Draw3DText', 'ShowHelpNotification', 'ESXShowHelpNotification'

Config.EnableTarget = false -- Disable the blips and default menus event for menus : qs-vehiclekeys:client:targetEvent
Config.Target = {
    TargetName = 'qb', -- 'qb' (qb-target) | 'qt' (qtarget) |'ox' (ox_target)
...
Config.HControls = {
    EngineControl = 'G', -- Key to start or stop the engine.
    LockUnlock = 'U',
}
...
Config.CopyKeysCost = 1000 -- Price of the copies of the keys, you can use 0 and it will be free.
...
Config.StealVehiclesPedsPolice = 100 -- This is the chance for the NPC to call the police after being robbed (1-100).
...
Config.AdvancedLockpickItem = 'advancedlockpick' -- Don't need police to lockpick
