...
config.Fuelexport = "cdn-fuel" -- Your Fuel Script
...
config.RentalLocations = {
    ...
    bike = { -- This is the section for the bike rental
        ...
        pedspawn = vector4(-239.28, -991.94, 28.29, 81), -- This is where the ped spawns
        heading = 317.04, -- heading of where the vehicle spawns
        vehiclespawn = vector4(-242.95, -993.65, 29.29, 256), -- Location where the vehicle spawns after being purchased
	},
}
...
config.BikeRental = { -- This is where you will edit the price and vehicle name, you can also remove vehicles or add
    [1] = {
        ...
        price = 250, -- the price to rent the vehicle
    },
    [2] = {
        header = 'Cruiser',
        carhash = 'cruiser',
