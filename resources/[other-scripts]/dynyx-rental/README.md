...
- Boat Rental
- Bike Rental
- You add cars through config
- Receive Emails when you rent a vehicle
- Icons on the Menu
...
```
3. Go to lj-inventory or lj-inventory / html / images and add in the images I put in that images folder.
4. Go to lj-inventory or lj-inventory / html / js / app.js and under line 546 paste this
```lua
