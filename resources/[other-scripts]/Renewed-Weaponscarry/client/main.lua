...
local PlayerSlots = {
	...
	[4] = { -- I use this for the pelts for hunting
		[1] = { bone = 24817, x = -0.18, y = -0.22, z = -0.02, xr = 0.0, yr = 91.0, zr = 5.0 },
	...
	[6] = { -- BIG SHITZ
		[1] = { bone = 24817, x = -0.25, y = -0.20, z = 0.12, xr = 0.0, yr = 90.0, zr = -75.0 },
	},
...
local props = {
	...
	-- ARS
	["weapon_ak47"] = { model = "w_ar_ak74", hash = joaat("weapon_ak47"), tier = 1 },
	...
	["weapon_sledgehammer"]    = { model = "w_me_sledgehammer", hash = joaat("weapon_sledgehammer"), tier = 6 },
	["weapon_katana"]    = { model = "w_me_katana", hash = joaat("weapon_katana"), tier = 2 },
	["weapon_keyboard"]    = { model = "w_me_keyboard", hash = joaat("weapon_keyboard"), tier = 4 },
