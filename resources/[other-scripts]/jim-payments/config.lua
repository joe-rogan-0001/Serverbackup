...
Config = {
	...
	PhoneType = "qs", -- Change this setting to make invoices work with your phone script [still testing this currently]
						-- "qb" for qb-phone
						-- "gks"" for GKSPhone
	...
	Jobs = {
		...
		['tuner'] = { MinAmountforTicket = 100, PayPerTicket = 500, Commission = 0.10, },
    ...
    CustomCashRegisters = {
		["tuner"] = { -- Player job role restriction
		{ coords = vector4(-217.40, -1335.49, 31.06, 266), prop = true, }, -- vector4 to place the till and the way it faces
	  },
	},
