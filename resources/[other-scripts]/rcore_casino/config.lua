Config = {
    -- Map
    MapType = 3, -- 1: for DLCiplLoader, 2: Gabz Casino, 3: NoPixel Casino, 4: k4mb1 casino, 5: GTA:O Interior (rcore_casino_interior)
    ...
    LUCKY_WHEEL_COOLDOWN = (1 * 1 * 1),--(60 * 60 * 24), -- how long players have to wait for their next spin. def: 24 hours (60 * 60 * 24)
    ...
    -- Job
    BossGrade = 1, -- the max grade (boss) for the casino job
    BossName = "boss",
