...
Config.DebugPoly = false -- If you are changing the locations i advise you put TRUE

Config.LocationsFitment = {
--[[    ['WheelFitment'] = { -- do not touch here PLEASE
        settings = {
            image = 'bennys',
            label = 'Bennys Wheel Fitment',
            welcomeLabel = "Welcome to Benny's Motorworks!",
            timer = 10000,
            enabled = true,
        },
        drawtextui = {
            text = "Adjust Wheel Fitment"
        },
        restrictions = {
            job = {'tuner'}
        },
        zones = {
            { coords = vector3(-222.10, -1336.18, 31.30), length = 6.0, width = 4.0, heading = 2.0, minZ = 29.88, maxZ = 33.48 },
        }
    },]]--
}
...
Config.Locations = {
    ['Innocence'] = {
        ...
        drawtextui = {
            text = "Bennys Original Motorworks"
        },
        restrictions = {
            job = {'tuner'}
        },
        zones = {
            { coords = vector3(-201.04, -1326.93, 31.30), length = 6.0, width = 4.0, heading = 90.0, minZ = 29.88, maxZ = 33.48 },
            { coords = vector3(-221.17, -1318.57, 31.30), length = 6.0, width = 4.0, heading = 201.0, minZ = 29.88, maxZ = 33.48 },
        }
    },
    ...
    ['BCSO'] = {
        ...
        zones = {
            { coords = vector3(1836.75, 3703.29, 33.97), length = 9.0, width = 4.0, heading = 126.0, minZ = 24.5, maxZ = 35.5 },
        }
    },
