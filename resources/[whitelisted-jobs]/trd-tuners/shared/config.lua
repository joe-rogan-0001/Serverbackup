...
Config.Version = "new" -- new = using export | old = using events
Config.Export = exports['qb-core']:GetCoreObject() -- uncomment this if using new qbcore version
--Config.Trigger = "QBCore:GetObject" -- uncomment this if using old qbcore version

Config.Debug = false -- Set to True to enable Debug Prints
Config.MoneyType = 'bank'
Config.RepairMoneyType = 'cash'
Config.AdminMenu = false -- Set false if you are not using qb-adminmenu ## https://github.com/qbcore-framework/qb-adminmenu ## OR IF YOU WANT TRIGGER ONLY ADMIN USE WEEHLFITMENT PUT THIS ON THE TRIGGER "qb-admin:client:ToggleDevmode"
...
vehicleCustomisationPrices = {
    cosmetics = {price = 400},
    respray = {price = 1000},
    performance = {prices = {0, 5250, 8500, 13450, 17250, 25500}},
    turbo = {prices = {0, 25000}},
    wheels = {price = 500},
