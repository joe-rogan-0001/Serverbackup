...
Config.DamageMinorToMajor = 100 -- How much damage would have to be applied for a minor weapon to be considered a major damage event. Put this at 100 if you want to disable it
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ...
    ["stash"] = {
        [1] = vector3(303.76, -600.34, 43.28),
    },
    ["beds"] = {
        [1] = {coords = vector4(324.26, -582.8, 42.84, 340), taken = false, model = 1631638868},
        [2] = {coords = vector4(322.62, -587.17, 42.84, 160), taken = false, model = 1631638868},
        [3] = {coords = vector4(319.41, -581.04, 42.84, 340), taken = false, model = 1631638868},
        [4] = {coords = vector4(317.67, -585.37, 42.84, 160), taken = false, model = 1631638868},
        [5] = {coords = vector4(314.47, -584.2, 42.84, 160), taken = false, model = 1631638868},
        [6] = {coords = vector4(313.93, -579.04, 42.84, 340), taken = false, model = 1631638868},
        [7] = {coords = vector4(311.06, -582.96, 42.84, 160), taken = false, model = 1631638868},
        [8] = {coords = vector4(309.35, -577.38, 42.84, 340), taken = false, model = 1631638868},
        [9] = {coords = vector4(307.72, -581.75, 42.84, 160), taken = false, model = 1631638868},
    },
    ["jailbeds"] = {
        [1] = {coords = vector4(1761.87, 2591.56, 45.3, 90), taken = false, model = 2117668672},
        [2] = {coords = vector4(1761.87, 2594.64, 45.3, 90), taken = false, model = 2117668672},
        [3] = {coords = vector4(1761.87, 2597.73, 45.3, 90), taken = false, model = 2117668672},
        [4] = {coords = vector4(1771.98, 2597.95, 45.3, 270), taken = false, model = 2117668672},
        [5] = {coords = vector4(1771.98, 2594.88, 45.3, 270), taken = false, model = 2117668672},
        [6] = {coords = vector4(1771.98, 2591.8, 45.3, 270), taken = false, model = 2117668672},
    },
    ["stations"] = {
