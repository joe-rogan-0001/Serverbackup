...
Config.tickupdate = 0 -- time to update the blips from server in seconds (performance matters)
Config.sirenupdate = 0 -- time to update siren state (client) in seconds (performance matters)
