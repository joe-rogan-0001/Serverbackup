...
RegisterNetEvent('qb-vehicleshop:server:buyShowroomVehicle', function(vehicle)
    ...
    if cash > tonumber(vehiclePrice) then
        ...
        TriggerEvent('qb-log:server:CreateLog', 'vehicleshop', ' Vehicle Shop', 'white', 'Player Name: ' .. playerName .. ' Player ID: ' .. playerId .. ' Purchased: ' .. vehicle .. ' For Cash Price: ' .. vehiclePrice ..' Vehicle Plate: ' .. plate, false)
