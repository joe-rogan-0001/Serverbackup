...
-- Function to sort vehicles alphabetically
function sortVehiclesAlphabetically(menu)
    if menu and type(menu) == "table" then
        table.sort(menu, function(a, b)
            if a.header == Lang:t('menus.goback_header') then
                return false
            elseif b.header == Lang:t('menus.goback_header') then
                return true
            else
        ...
        print("Error: sortVehiclesAlphabetically received a nil or invalid table.")
    end
end
...
RegisterNetEvent('qb-vehicleshop:client:vehCategories', function()
    ...
    sortVehiclesAlphabetically(categoryMenu)
...
RegisterNetEvent('qb-vehicleshop:client:openVehCats', function(data)
    ...
    sortVehiclesAlphabetically(categoryVehicles)
    for _, vehicle in ipairs(categoryVehicles) do
        table.insert(vehMenu, vehicle)
    end
...
RegisterNetEvent('qb-vehicleshop:client:buyShowroomVehicle', function(vehicle, plate)
    ...
    QBCore.Functions.TriggerCallback('QBCore:Server:SpawnVehicle', function(netId)
        ...
        exports['qs-vehiclekeys']:GiveKeysAuto() -- here!
