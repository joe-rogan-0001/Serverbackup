...
Shared.MinSpeed = 60 -- Minimum speed in MPH required to perform a hack
...
Shared.MoneyType = 'cash' -- The moneytype used to start a contract, make sure to edit the strings in the UI too in the app.js to fit your moneytype. i.e Change QBit to Cash
...
Shared.MinCops = 2 -- Minimum cops required for the server to send contracts if CopsRequired option enabled
Shared.CopsRequired = true -- Settings this to true stops players from getting contracts when insufficient (Shared.MinCops) cops are online.

Shared.Contracts = {
    ['D'] = {
        vehicles = {'cheburek', 'dilettante', 'washington', 'issi2', 'tornado', 'bison', 'minivan'}, -- You can always add more vehicles here
    ...
    ['A'] = {
        vehicles = {'infernus2', 'massacro', 'felon', 'oracle2', 'jackal', 'schafter2', 'kuruma'},
        locations = {
            [1] = {
    ...
    ['S'] = {
        vehicles = {'t20', 'zentorno', 'turismor', 'massacro2'},
        locations = {
            [1] = {
