...
RegisterNetEvent('qb-drugsystem:client:StartPackage', function(data)
    ...
    local hasItem = QBCore.Functions.HasItem(Shared.DrugLabs['meth'].items.curedItem, 1) or QBCore.Functions.HasItem(Shared.DrugLabs['coke'].items.curedItem, 1) or QBCore.Functions.HasItem(Shared.DrugLabs['weed'].items.curedItem, 1)
    if not hasItem then
