...
InventoryBusy = function(bool)
    ...
    --TriggerServerEvent("OpenInventory", bool) -- for lj-inventory
    --LocalPlayer.state:set("inv_busy", bool, true) -- for lj-inventory Choose whanever what's working on your side I'm using Ox-Inv rn so XD
end
