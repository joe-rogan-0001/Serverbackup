...
RegisterNetEvent('scoreboard:playerLoaded', function(players)
...
RegisterNetEvent('scoreboard:addPlayer', function(playerData)
    Scoreboard.players[#Scoreboard.players + 1] = playerData
end)

RegisterNetEvent('scoreboard:removePlayer', function(playerData)
...
local function OpenScoreboard()
    SendNUIMessage({
        ...
        slots       = GetConvarInt('sv_maxclients', 8)
    })
end
