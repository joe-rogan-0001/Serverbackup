...
Config.PedLocation = vector4(205.82, -922.52, 29.82, 160)
...
Config.PhoneItem = 'phone' -- Name of your phone item
Config.CopsNeeded = 0
Config.BuyerTimer = math.random(2, 3) -- Timer till the buyer spawns default 1-3 minutes

Config.PedDrivingStyle = 786603 -- suggest not changing this tbh
Config.PedDrivingSpeed = 6.0
Config.Packages = math.random(5, 10) -- amount of packages you recieve to deliver

--- REWARD STUFF HERE
Config.UseStartPayment = true -- true/false if you want to use a start payment or not
Config.OxyStartPayment = 2500 -- amount to pay to start if the config is set to true
Config.OxyPackageName = 'oxy-box' -- name of the box package in your shared
Config.MinPay = 250 -- minimum anount of cash you revieve upon handoff
Config.MaxPay = 1000 -- maximum anount of cash you revieve upon handoff
...
Config.RareItemAmount = 1 -- Amount of the rare item you reacieve
...
Config.OxyLocations = {
    [1] = {
        ...
        CarSpawn = vector4(-308.38, -1500.82, 29.53, 236.82), -- where the buyer car spawns
    ...
    [2] = {
        ...
        CarSpawn = vector4(-294.42, -2194.84, 9.39, 322.54),
        Peds = {
            `csb_ballasog`,
            `g_m_y_ballasout_01`,
            `g_m_y_ballaeast_01`,
    ...
    [4] = {
        ...
        CarSpawn = vector4(-702.92, 298.51, 82.81, 175.16),
        Peds = {
            `csb_ballasog`,
            `g_m_y_ballasout_01`,
            `g_m_y_ballaeast_01`,
    ...
    [6] = {
        ...
        CarSpawn = vector4(1025.29, -2441.64, 27.53, 175.37),
        Peds = {
            `csb_ballasog`,
            `g_m_y_ballasout_01`,
            `g_m_y_ballaeast_01`,
