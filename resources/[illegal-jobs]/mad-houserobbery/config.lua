...
Config.MinimumJobPolice = 0 --number of police to rob houses
...
Config.StartPedLoc = vector4(208.15, -923.40, 29.80, 163) --Start mission ped
...
Config.SafeRewards = { -- It will pick a random combination from this table.
    ...
    [3] = {
        {name = "white_phone", amount = math.random(1,5), info = {}, type = "item", slot = 1},
        {name = "goldchain", amount = math.random(1,5), info = {}, type = "item", slot = 2},
    },
    [4] = {
        {name = "white_phone", amount = math.random(1,3), info = {}, type = "item", slot = 1},
        {name = "pistol_ammo", amount = math.random(1,4), info = {}, type = "item", slot = 2},
        {name = "rolex", amount = math.random(1,10), info = {}, type = "item", slot = 3},
        {name = "white_phone", amount = math.random(1,3), info = {}, type = "item", slot = 4},
        {name = "goldchain", amount = math.random(1,10), info = {}, type = "item", slot = 5},
    },
    [5] = {
        {name = "pistol_ammo", amount = math.random(1,4), info = {}, type = "item", slot = 1},
        {name = "rolex", amount = math.random(1,10), info = {}, type = "item", slot = 2},
        {name = "white_phone", amount = math.random(1,3), info = {}, type = "item", slot = 3},
