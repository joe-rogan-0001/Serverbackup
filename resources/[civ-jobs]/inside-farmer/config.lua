...
Config.jobname = 'farmer' --name of the job that is required

Config.PayoutL = math.random(950, 1350) --price for lettuce
Config.PayoutP = math.random(950, 1350) --price for potatoes
Config.PayoutC = math.random(950, 1350) --price for cucumbers
