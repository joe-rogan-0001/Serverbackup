...
Config.Garages = {
    ...
    ['bennysparking'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(-247.64, -1341.70),
                vector2(-231.52, -1341.70),
                vector2(-232.33, -1313.10),
                vector2(-246.93, -1312.25)
            },
            ['minZ'] = 29.0,  -- min height of the parking zone
            ['maxZ'] = 40.0,  -- max height of the parking zone
        },
        label = "Benny's Parking",
        showBlip = false,
        blipcoords = vector3(-240.54, -1327.06, 31.30),
        blipName = "Public Parking",
        blipNumber = 357,
        type = 'public',                --public, job, gang, depot
        vehicleCategories = {'car', 'motorcycle', 'other'},
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(-238.19, -1314.88, 31.30, 184),
            vector4(-241.57, -1314.95, 31.30, 186),
            vector4(-244.92, -1314.92, 31.29, 185),
            vector4(-244.84, -1338.97, 31.30, 6),
            vector4(-241.47, -1338.89, 31.30, 2),
            vector4(-237.89, -1338.89, 31.30, 1),
            vector4(-234.55, -1338.88, 31.30, 3)
        }
    },
    ['dealershipparking'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(95.42, -147.00),
            vector2(106.70, -150.51),
            vector2(116.11, -124.06),
            vector2(105.85, -120.37)
            },
            ['minZ'] = 25.0,  -- min height of the parking zone
            ['maxZ'] = 55.0,  -- max height of the parking zone
        },
        label = "Dealership Parking",
        showBlip = false,
        blipcoords = vector3(107.01, -131.24, 54.75),
        blipName = "Public Parking",
        blipNumber = 357,
        type = 'public',                --public, job, gang, depot
        vehicleCategories = {'car', 'motorcycle', 'other'},
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(113.39, -124.41, 54.75, 72),
            vector4(112.03, -127.62, 54.75, 66),
            vector4(110.80, -130.84, 54.75, 78),
            vector4(109.45, -134.02, 54.75, 74),
            vector4(108.24, -137.31, 54.75, 66),
            vector4(106.98, -140.38, 54.75, 71),
            vector4(105.92, -143.20, 54.75, 62),
            vector4(104.82, -145.83, 54.75, 67)
        }
    },
    ['catcafeparking'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
            vector2(-569.25903320313, -1166.4929199219),
            vector2(-605.32727050781, -1166.2687988281),
            vector2(-603.41412353516, -1091.1290283203),
            vector2(-562.52978515625, -1093.6641845703)
            },
            ['minZ'] = 20.0,  -- min height of the parking zone
            ['maxZ'] = 50.0,  -- max height of the parking zone
        },
        label = "Cat-Cafe Parking",
        showBlip = false,
        blipcoords = vector3(107.01, -131.24, 54.75),
        blipName = "Public Parking",
        blipNumber = 357,
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(-573.15, -1100.91, 22.18, 272.45),
            vector4(-573.4, -1104.68, 22.18, 275.31),
            vector4(-573.35, -1108.45, 22.18, 274.71),
            vector4(-573.26, -1111.95, 22.18, 273.49),
            vector4(-573.4, -1115.76, 22.18, 276.12),
            vector4(-573.26, -1119.49, 22.18, 272.49),
            vector4(-573.47, -1123.02, 22.18, 275.11),
            vector4(-573.19, -1126.7, 22.18, 273.86),
            vector4(-573.29, -1130.47, 22.18, 274.15),
            vector4(-573.33, -1134.16, 22.18, 275.46),
            vector4(-584.92, -1161.6, 22.18, 269.21),
            vector4(-585.12, -1157.72, 22.18, 272.22),
            vector4(-585.16, -1154.24, 22.18, 271.12),
            vector4(-585.19, -1150.54, 22.18, 270.54),
            vector4(-585.17, -1146.89, 22.18, 269.09),
            vector4(-595.31, -1141.41, 22.18, 274.97),
            vector4(-595.28, -1137.64, 22.18, 270.95),
            vector4(-595.28, -1133.97, 22.18, 271.77),
            vector4(-595.34, -1130.41, 22.18, 271.43),
            vector4(-595.42, -1126.7, 22.18, 271.15),
            vector4(-595.41, -1123.07, 22.18, 270.42),
            vector4(-595.16, -1119.27, 22.18, 272.88),
            vector4(-595.46, -1115.61, 22.18, 279.06),
            vector4(-595.26, -1111.92, 22.18, 272.03),
            vector4(-581.68, -1100.89, 22.18, 94.62),
            vector4(-581.67, -1104.55, 22.18, 90.77),
            vector4(-581.58, -1108.21, 22.18, 91.27),
            vector4(-581.49, -1111.9, 22.18, 95.42),
            vector4(-581.46, -1115.53, 22.18, 97.38),
            vector4(-581.66, -1119.16, 22.18, 89.92),
            vector4(-581.65, -1122.87, 22.18, 89.53),
            vector4(-581.57, -1126.5, 22.18, 90.82),
            vector4(-581.62, -1130.05, 22.18, 87.69),
            vector4(-581.64, -1134.01, 22.18, 91.78)
        }
    },
    ['legionsquare'] = {
        ['Zone'] = {
    ...
    ['bcsogarage'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(1837.98, 3689.90),
                vector2(1834.84, 3695.62),
                vector2(1812.03, 3682.03),
                vector2(1814.70, 3676.36),
            },
            ['minZ'] = 24.0,  -- min height of the parking zone
            ['maxZ'] = 37.50,  -- max height of the parking zone
        },
        label = 'BCSO Garage',
        type = 'job',
        job = {"bcso", "police"},
        ...
        drawText = 'Parking',
        ["ParkingSpots"] = {
            vector4(1815.38, 3679.50, 33.97, 35),
            vector4(1818.62, 3681.30, 33.97, 33),
            vector4(1825.32, 3685.41, 33.97, 38),
            vector4(1828.58, 3687.13, 33.97, 37),
            vector4(1832.12, 3688.97, 33.97, 34),
            vector4(1835.38, 3690.81, 33.97, 33)
        },
        debug = false
    },
    ['helipad'] = {
