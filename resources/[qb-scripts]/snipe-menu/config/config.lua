...
Config.CommandName = "ad" -- command to open the menu
...
Config.Discord = "https://discord.gg/SPbGHZmuKt" -- discord link to show when you ban a player in the ban message
