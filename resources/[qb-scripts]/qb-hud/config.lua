...
Config.OpenMenu = 'END' -- https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
...
Config.MinimumSpeed = 110 -- Going Over This Speed Will Cause Stress
